...
<body>
  ...
  <div class="row ">
    <div class="" style="max-width:300px; margin: 30px auto 0px;">
      <a href="#">
        <img src="<?=base_url();?>assets/img/bolishu.png"></a>
    </div>
        ...
        <p>
          <div class="input-prepend">
            <span class="add-on" style="height:40px;">
              &nbsp; <i class="icon-envelope" style="margin-top:10px;"></i>
              &nbsp;
            </span>
            <input class="span3" style="height:40px;" id="prependedInput" size="16" type="text" name="email" placeholder="邮箱地址"></div>
        </p>
      </div>
      <div>
        <p>
          <div class="input-prepend">
            <span class="add-on" style="height:40px;">
              &nbsp; <i class="icon-user" style="margin-top:10px;"></i>
              &nbsp;
            </span>
            <input class="span3" style="height:40px;" id="prependedInput" size="16" type="text" name="username" placeholder="用户名称"></div>
        </p>
      </div>
      <div class="">
        <p>
          <div class="input-prepend">
            ...
            <input class="span3" style="height:40px;" id="prependedInput" size="16" type="password" name="password" placeholder="密码"></div>
        </p>
      </div>
      <div class="">
        <p>
          <div class="input-prepend">
            <span class="add-on" style="height:40px;">
              &nbsp;
              <i class="icon-retweet" style="margin-top:10px;"></i>
              &nbsp;
            </span>
            <input class="span3" style="height:40px;" id="prependedInput" size="16" type="password" name="password" placeholder="重复密码"></div>
        </p>
      </div>
  ...
  <script>
      $.backstretch("<?=base_url();?>assets/img/b.jpg");</script>
</div>
